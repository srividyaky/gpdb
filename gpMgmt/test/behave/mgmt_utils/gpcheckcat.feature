...
Feature: gpcheckcat tests
    ...
    Scenario: Validate if gpecheckcat throws error when there are tables created using mix distribution policy
        ...
        And gpcheckcat should print "Found both type tables \(legacy or modern opclass as its distribution policy\) in the same database." to stdout
        And gpcheckcat should print "Please run the gpcheckcat.distpolicy.sql file to list two types of tables." to stdout
