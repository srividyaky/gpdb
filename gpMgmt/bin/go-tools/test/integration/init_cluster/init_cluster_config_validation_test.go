...
func GetDefaultConfig(t *testing.T, expansion ...bool) *viper.Viper {
	...
	if len(expansion) == 1 && expansion[0] {
		...
		// 	hostList = append(hostList, hostList[0])
...
// func UnsetConfigKey(t *testing.T, filename string, key string, newfile bool, expansionParam ...bool) {
// 	t.Helper()

// 	var config *viper.Viper

// 	if len(expansionParam) > 0 && expansionParam[0] {
// 		// Use GetDefaultConfig with extensionParam
// 		config = GetDefaultConfig(t, true)
// 	} else if newfile {
// 		config = GetDefaultConfig(t)
// 	} else {
...
// func SetConfigKey(t *testing.T, filename string, key string, value interface{}, newfile bool, expansionParam ...bool) {
// 	t.Helper()
